...
<body>
    ...
    <div class="contenedor_tablas">
        ...
        <div class="container mt-5 margtop0">
            <div class="row">
                <a href="{{route('adminCategoria.create')}}" class="btn btn-primary col-lg-2 col-5" style="float: right;margin-right: 50px">Crear Producto</a>
                <table class="table table-bordered mb-5 col-lg-12 col-12">
                    <thead>
