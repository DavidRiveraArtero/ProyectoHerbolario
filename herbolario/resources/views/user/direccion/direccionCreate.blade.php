...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-12 form_direccion">
                <form style="margin-top: 15px" method="post" action="{{route("direccion.store")}}">
                    ...
                    <input name="nombre" class="col-lg-12 col-12 border_bottom" type="text" placeholder="Nombre" value="{{Auth::user()->name}}"><br/><br/><br/>

                    <h4 class="col-lg-12 col-12">Numero de telefono</h4>
                    <input name="telefono" class="col-lg-12 col-12 border_bottom" type="text" placeholder="Numero de telefono"><br/><br/><br/>

                    <h4 class="col-lg-12 col-12">Direccion</h4>
                    <input name="direccion" class="col-lg-12 col-12 border_bottom" type="text" placeholder="Direccion"><br/><br/><br/>
                    <div class="col-lg-6 col-12" style="float: left">
                        <h4 class="col-lg-11 col-12">Codigo Postal</h4>
                        <input name="codigo_postal" class="col-lg-11 col-12 border_bottom" type="text" placeholder="Codigo Postal">
                    </div>
                    <div class="col-lg-6 col-12" style="float: left">
                        <h4 class="col-lg-11 col-12">Ciudad</h4>
                        <input name="ciudad" class="col-lg-12 col-12 border_bottom" type="text" placeholder="Ciudad">
                    </div>
                    <br/><br/><br/><br/><br/>
                    <div>
                        <h4 class="col-lg-12 col-12">Provincia</h4>
                        <input name="provincia" class="col-lg-12 col-12 border_bottom" type="text" placeholder="Provincia"><br/><br/><br/>
                    </div>
                    <div class="col-lg-12 col-12" style="text-align: center">
                        <button type="submit" class="btn btn-success col-lg-6 col-12">Crear</button>
                    </div>
                </form>
            </div>
        </div>
